...
private  String baseUrl="ec2-54-89-146-161.compute-1.amazonaws.com/ords/hr";
    //we start from given()
...
Response response=given().
             get("http://ec2-54-89-146-161.compute-1.amazonaws.com/employees/");
...
@Test
    public  void Test2(){
        Response response=given().
                ...
                get("http://ec2-54-89-146-161.compute-1.amazonaws.com:1000/ords/hr/employees/100");
    ...
    @Test
    public void test3(){
        Response response = given().get("http://ec2-54-89-146-161.compute-1.amazonaws.com:1000/ords/hr/regions");
        assertEquals(200, response.getStatusCode());
